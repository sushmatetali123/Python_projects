...
# bs4 Beautiful Soup is a Python package for analysing HTML and XML documents
...
# speech_recognition recognises speech supporting several engines and APIs(Application program interface.
...
def main():
    ...
    def google(name):
        ...
        try:
            res = requests.get(
                f'https://www.google.com/search?q={name2}&oq={name2}&aqs=chrome..69i57j46j69i59j35i39j0j46j0l2.4948j0j7&sourceid=chrome&ie=UTF-8',
                headers=headers)
    ...
    if __name__ == "__main__":
        ...
        photo = PhotoImage(file="C:\\Users\\Admin\\Desktop\\python_project\\Google-Search-Query-Assistant-master\\profile.png")
        ...
        photobutton = PhotoImage("mic.png")
